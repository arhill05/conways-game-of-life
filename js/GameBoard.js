...
export default class GameBoard {
  ...
  evaluateCells = () => {
    ...
    const cellsToKill = this._cells.filter(cell => cell.isAlive && ruleEvaluator.shouldDie(cell, this.getNeighbors(cell)));
    const cellsToRevive = this._cells.filter(cell => !cell.isAlive && ruleEvaluator.shouldRevive(cell, this.getNeighbors(cell)));
  ...
  getNeighbors = (cell) => {
    ...
    const neighbors = this._cells.filter(c =>
