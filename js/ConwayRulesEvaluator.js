...
const isUnderpopulated = (neighboringCells) => getLiveCellCount(neighboringCells) < 2;
...
const isOverPopulated = (neighboringCells) => getLiveCellCount(neighboringCells) > 3;

// rule 4: Any dead cell with exactly three live neighbours becomes a live cell, as if by reproduction.
const isBecomingAlive = (neighboringCells) => getLiveCellCount(neighboringCells) === 3;
